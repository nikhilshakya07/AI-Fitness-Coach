...
export const userProfileSchema = z.object({
  ...
  fitnessGoal: z.enum(["weight_loss", "muscle_gain", "endurance", "general_fitness", "strength", "flexibility"], {
  ...
  workoutLocation: z.enum(["home", "gym", "outdoor"], {
    required_error: "Please select your workout location",
  }),
  dietaryPreference: z.enum(["veg", "non_veg", "vegan", "keto", "paleo", "mediterranean"], {
